...
import { Calendar, Clock, Globe, ChevronDown, Sparkles, ArrowRight, Zap, BarChart3 } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 relative max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 xl:w-5/12 mb-8 lg:mb-0">
              ...
              >
                Maximize your content's impact with AI-driven scheduling. Reach your audience at the perfect moment, every time.
              </motion.p>
              ...
              >
                {[
                  { icon: Calendar, text: "Schedule content across all social platforms" },
                  { icon: Clock, text: "AI-powered optimal posting time suggestions" },
                  { icon: Globe, text: "Timezone-aware scheduling for global reach" },
                  { icon: BarChart3, text: "Real-time analytics to refine your strategy" }
                ].map((feature, index) => (
                  <motion.div 
                    key={index}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              ...
              <div className="bg-black/30 rounded-lg border border-white/10 overflow-hidden">
                ...
                <div className="flex items-center px-4 py-2 bg-[#1A1A1A] border-b border-white/10">
                  ...
                  <div className="flex-1 text-center text-sm text-gray-400">Schedule Suite</div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12">
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-medium text-white">Schedule Posts</h3>
                    </div>
                    ...
                    <div className="bg-black rounded-lg border border-white/10 p-4">
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-7 gap-1">
                          {[...Array(7)].map((_, index) => (
                            <div key={index} className="h-8 bg-white/5 rounded" />
                          ))}
                        </div>
                        ...
                        <div className="mt-6 p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm text-purple-300">AI Scheduling Suggestions</span>
                          </div>
                          <div className="space-y-2">
                            <div className="h-3 bg-purple-500/20 rounded w-full" />
                            <div className="h-3 bg-purple-500/20 rounded w-4/5" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex justify-center space-x-4">
                      {['facebook', 'twitter', 'instagram', 'linkedin'].map((platform) => (
                        <div key={platform} className="w-8 h-8 bg-white/10 rounded-full" />
                      ))}
                    </div>
                  </motion.div>
                </div>
